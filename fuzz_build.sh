...
echo "Building fuzz_macsec_parser (no crypto deps)..."
clang $CFLAGS_COMMON -o fuzz_macsec_parser fuzz_macsec_parser.c

echo "Building fuzz_homeplugav_parser (no crypto deps)..."
clang $CFLAGS_COMMON -o fuzz_homeplugav_parser fuzz_homeplugav_parser.c
...
echo "  ./fuzz_macsec_parser fuzz_seeds/macsec/ -max_len=256"
echo "  ./fuzz_homeplugav_parser fuzz_seeds/homeplugav/ -max_len=128"
